...
{
    public static class RandomCharacterPassword
    {
        private static readonly StringBuilder Password = new StringBuilder();
        private const string ValidCharacters = "abcdefghjkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ23456789#@%&*$";
        ...
        public static string ReturnGoodPassword(int passwordLength)
        {
